...
public class Cliente implements Serializable {
	...
	// nesse caso vamos criar tudo pelo JPA
	@ElementCollection
	@CollectionTable(name = "TELEFONE")
	private Set<String> telefones = new HashSet<>(); // set(conjunto) não aceita repetição

	@JsonIgnore
	@OneToMany(mappedBy = "cliente")
	private List<Pedido> pedidos = new ArrayList<>(); // Coleção n colocamos no construtor
